...
public class SearchActor extends SearchBaseActor {
    ...
    private SearchDTO getSearchDTO(Request request) throws Exception {
        ...
        try {
            ...
            String secureContent = (String) req.get(SearchConstants.searchSecureContent);
            if (!secureContent.isEmpty() && secureContent.equals("true"))
                searchObj.addAdditionalProperty(SearchConstants.searchSecureContent,secureContent);
